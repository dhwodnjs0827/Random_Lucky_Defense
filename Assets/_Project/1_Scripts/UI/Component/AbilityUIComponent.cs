...
public class AbilityUIComponent : MonoBehaviour
{
    ...
    public void SetAbilityData(AbilityContainer ability)
    {
        ...
        abilityDescription.text = currentAbility.AbilityData.Description.ReplaceValues(
            ("{value}", ability.AbilityLevelData.value), ("{value1}", ability.AbilityLevelData.value1));
